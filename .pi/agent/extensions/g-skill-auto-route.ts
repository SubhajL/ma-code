...
export const SKILL_PATTERNS: Array<{ skill: SkillName; reason: string; patterns: RegExp[] }> = [
  ...
  {
    skill: "g-grill",
    reason: "matched clarification/brainstorm/research intent",
    patterns: [
      /\bg-grill\b/i,
      /\bbrainstorm\b/i,
      /\bideate\b/i,
  ...
  {
    skill: "g-prd",
    reason: "matched PRD/spec intent",
    patterns: [
      /\bg-prd\b/i,
      /\bcreate\s+(a\s+)?prd\b/i,
      /\bwrite\s+(a\s+)?prd\b/i,
      /\bproduct\s+requirements?\s+doc(?:ument)?\b/i,
      /\bproduct\s+spec\b/i,
      /\brequirements?\s+doc(?:ument)?\b/i,
      /\bwrite\s+(a\s+)?spec\b/i,
    ],
  },
  {
    skill: "g-issues",
    reason: "matched backlog/task slicing intent",
    patterns: [
      /\bg-issues\b/i,
      /\bcreate\s+tasks\b/i,
      /\bbacklog\s+tasks?\b/i,
      /\bbreak\s+.*\binto\s+tasks\b/i,
      /\bsplit\s+.*\binto\s+issues?\b/i,
      /\bissue\s+breakdown\b/i,
      /\bvertical\s+slices?\b/i,
      /\bkanban\b/i,
      /\btickets?\b/i,
      /\bbacklog\b/i,
    ],
  ...
  {
    skill: "g-refactor",
    reason: "matched refactor/deep-module intent",
    patterns: [
      /\bg-refactor\b/i,
      /\brefactor\b/i,
      /\bdeep\s+module\b/i,
      /\bimprove\s+codebase\s+architecture\b/i,
      /\brestructure\b/i,
      /\bextract\s+(a\s+)?seam\b/i,
      /\bdeletion\s+test\b/i,
      /\binterface\s+seam\b/i,
    ],
  },
  {
    skill: "g-planning",
