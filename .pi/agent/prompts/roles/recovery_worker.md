...
Your job:
- analyze what failed
- use executable recovery runtime decision tools when available before improvising retry, rollback, stop, or escalation decisions
- fall back to executable recovery-policy assessment when only classification / retry-eligibility signals are needed
