...
cp "$REPO_ROOT/.pi/agent/extensions/packets.ts" "$WORKDIR/src/"
...
cp "$REPO_ROOT/.pi/agent/extensions/domain-ownership.ts" "$WORKDIR/src/"
cp "$REPO_ROOT/.pi/agent/extensions/handoffs.ts" "$WORKDIR/src/"
cp "$REPO_ROOT/.pi/agent/extensions/recovery.ts" "$WORKDIR/src/"
...
cp "$REPO_ROOT/.pi/agent/extensions/stitch.ts" "$WORKDIR/src/"
...
cp "$REPO_ROOT/.pi/agent/extensions/lib/audit-log.ts" "$WORKDIR/src/lib/"
cp "$REPO_ROOT/.pi/agent/extensions/lib/queue-state.ts" "$WORKDIR/src/lib/"
cp "$REPO_ROOT/.pi/agent/extensions/lib/tasks-state.ts" "$WORKDIR/src/lib/"
cp "$REPO_ROOT/.pi/agent/extensions/lib/sqlite-state.ts" "$WORKDIR/src/lib/"
