...
- Date: 2026-04-21
- Generated at: 2026-04-21T20:59:27+0700
- Repo root: /Users/subhajlimanond/dev/ma-code-harness-032
- Python binary: python3
- Temporary root: /var/folders/mp/3ghkj_pn7kz5nb25brmtq8000000gn/T/tmp.BTgzW0Ed9Z
...
### Command
```bash
python3 /var/folders/mp/3ghkj_pn7kz5nb25brmtq8000000gn/T/tmp.BTgzW0Ed9Z/check_1_queue_schema_contract.py
```
...
### Command
```bash
python3 /var/folders/mp/3ghkj_pn7kz5nb25brmtq8000000gn/T/tmp.BTgzW0Ed9Z/check_2_runtime_placeholder_alignment.py
```
...
### Command
```bash
python3 /var/folders/mp/3ghkj_pn7kz5nb25brmtq8000000gn/T/tmp.BTgzW0Ed9Z/check_3_queue_docs_alignment.py
```
...
### Command
```bash
python3 /var/folders/mp/3ghkj_pn7kz5nb25brmtq8000000gn/T/tmp.BTgzW0Ed9Z/check_4_discoverability_wiring.py
```
...
- Overall status: PASS
- Failed checks: 0
- Summary JSON: /Users/subhajlimanond/dev/ma-code-harness-032/reports/validation/2026-04-21_queue-semantics-validation-script.json
